const STORAGE_KEY = 'debates-custom-chat'

export function loadCustomDebate() {
  try {
...
export function saveCustomDebate({ topic, agents, posts, lastMentioned, draft }) {
  try {
...
export function clearCustomDebate() {
  try {
